 ...
 */
public class DPS extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentDPSBinding.inflate(inflater,container,false)).getRoot();
    }
        ...
        PushDownAnim.setPushDownAnimTo(binding.buttonBack3).setScale(PushDownAnim.MODE_SCALE,0.89f)
                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        navController.navigate(R.id.action_DPS_to_informacion);
                    }
                });
        binding.imageButtonAna15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController.navigate(R.id.action_DPS_to_anaFragment);
            }
        });
